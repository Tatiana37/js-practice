...
// функция конструктор и свойство прототайп
...
//  2 в этом св-ве лежит ссылка на его ПРОТОТИП, те другой объект
//  3 при написании кода в св-ве прото записывается  ...
//  функция.prototype
...
// console.log(objA === Object.prototype); // false
// console.log(objA.__proto__ === Object.prototype); // true

//  4 ФУНКЦИЯ-конструктор - это просто функция!
//  5 всю магию делает оператор NEW
//  6 если ф-ция вызывается через New - создается пустой объект
//  7 ф-ция вызывается в контексте созданного (пустого) объекта
//  8 в свойстве __proto__  записывается ссылка на объект функция.prototype
//  например : this = Object.create(User.prototype)
...
//  в них нет this, или он бесполезен
...
// User.message = "я статическое св-во, меня нет на экземплярах";
